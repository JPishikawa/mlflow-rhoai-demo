...
def get_settings() -> Settings:
    return Settings(
        vllm_api_key=_clean_env("VLLM_API_KEY", "dummy"),
        vllm_api_base=_clean_env("VLLM_BASE_URL", "http://127.0.0.1:8000/v1"),
        vllm_model=_clean_env("VLLM_MODEL", "openai/gpt-oss-20b"),
